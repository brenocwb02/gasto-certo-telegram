...
const Settings = () => {
  ...
  useEffect(() => {
    ...
    if (meta) {
      meta.setAttribute("content", "Configure sua conta do Boas Contas: vincule o Telegram, gerencie assinatura e ajuste preferências.");
    }
      ...
      <div className="space-y-6">
        ...
        <Card className="financial-card shadow-sm">
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-base">
              Informações sobre sua assinatura do Boas Contas
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-5">
            {licenseLoading ? (
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 pt-1">
                    <p className="font-semibold mb-1">Copie seu código de assinatura</p>
                    <p className="text-sm text-muted-foreground">Use o botão "Copiar" na seção de Assinatura acima</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary text-primary-foreground font-bold text-lg shadow-md">
